function largestProductinaSeries(n) {
    ...
    adjacentArr(thousandDigits, n);
    
}

// function for reduce method
function totalArr(total, num) {
    return total * num
}

function adjacentArr(arr, num) {
    let largestAdj = 1;

    for (let i = 0; i < arr.length; i += num) {

        let newArr = arr.slice(i, i + num).reduce(totalArr, 1);
        
        if (newArr > largestAdj) {
            largestAdj = newArr
        }
        
    } 

    console.log(largestAdj)
}
